    ...
    <section className="w-full bg-white py-24">
      <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-[48px] font-semibold leading-tight text-gray-800 tracking-tight">
            PROCESS
            <br />
            OF BUYING
          </h1>
          <div className="h-2 w-16 bg-gray-800 mt-20"></div>
        </div>
        ...
        <div className="space-y-20">
          ...
          <div className="flex gap-10 items-start">
            <span className="text-[120px] leading-none font-bold text-gray-800">
              1
            </span>
            <div>
